...
class WhatsAppListener(Node):
            ...
            try:
                ...
                for line in process.stdout:
                    ...
                    try:
                        ...
                        self.get_logger().warning(f'Unexpected wa_listener output: {line}')

                process.wait()
                if rclpy.ok():
                    self.get_logger().warning('wa_listener.js exited, restarting in 5s...')
                    time.sleep(5)
    ...
    def _send_whatsapp(self, recipient: str, message: str):
        ...
        try:
            ...
            # Lock protects against concurrent threads corrupting the payload
            ...
            self.get_logger().warning('wa_listener stdin unavailable, falling back to mudslide')
