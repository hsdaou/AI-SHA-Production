...
class Phase8BRevDAdapterContract(unittest.TestCase):
    ...
    def test_release_ledger_matches_phase8b_evidence(self) -> None:
        ...
        self.assertEqual(release["phase8b_rev_d_adapter_focused_tests_passed"], "13/13")
        self.assertTrue(release["phase8b_rs485_read_only_transport_prepared"])
        self.assertTrue(release["phase8b_rs485_pseudoterminal_loopback_passed"])
        self.assertTrue(release["phase8b_hardware_attachment_audit_completed"])
        self.assertFalse(release["phase8b_hardware_attachment_gate_passed"])
        self.assertFalse(release["phase8b_v4_2_manual_found"])
        self.assertFalse(release["phase8b_stable_usb_rs485_device_found"])
