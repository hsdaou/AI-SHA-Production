...
exec "$SCRIPT_DIR/run_administration_nav2_bridge.sh" \
  --task "Isaac-AISHA-Administration-Live-Measured-Nav2-Phase7E-StaticFusion-FullOffice-Safety-Direct-v0" \
  ...
  --output-report "$SIM_ROOT/results/administration_nav2_phase7e_static_fusion_bridge.json" \
  "$@"
