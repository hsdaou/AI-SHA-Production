...
exec python3 "$SCRIPT_DIR/run_administration_nav2_mission.py" \
  ...
  --control-stack nav2_mapped_doorway_phase7e_static_fusion_full_office_safety \
  --waypoint-timeout-s 180 \
  --output "$SIM_ROOT/results/administration_nav2_phase7e_static_fusion_mission.json" \
  "$@"
