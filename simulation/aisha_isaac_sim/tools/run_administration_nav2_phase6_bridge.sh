...
exec "$SCRIPT_DIR/run_administration_nav2_bridge.sh" \
  --task "Isaac-AISHA-Administration-Live-Measured-Nav2-Phase6-HighSpeed80-DynamicSafety-Direct-v0" \
  ...
  --output-report "$SIM_ROOT/results/administration_nav2_phase6_high_speed_bridge.json" \
  "$@"
