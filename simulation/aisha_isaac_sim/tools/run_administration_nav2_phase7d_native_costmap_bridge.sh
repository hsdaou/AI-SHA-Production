...
exec "$SCRIPT_DIR/run_administration_nav2_bridge.sh" \
  --task "Isaac-AISHA-Administration-Live-Measured-Nav2-Phase7D-NativeCostmap-SafeWait-Safety-Direct-v0" \
  ...
  --output-report "$SIM_ROOT/results/administration_nav2_phase7d_native_costmap_bridge.json" \
  "$@"
