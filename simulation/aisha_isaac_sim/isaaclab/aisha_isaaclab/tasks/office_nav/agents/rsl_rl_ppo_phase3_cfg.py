...
@configclass
class AishaPhase3ClearancePlannerPPORunnerCfg(AishaPhase3SafetyResidualPPORunnerCfg):
    """Recurrent PPO for brake and clearance-projected steering requests."""

    seed = 9601
    num_steps_per_env = 64
    max_iterations = 600
    save_interval = 25
    run_name = "phase3l_clearance_planner_seed9601"
    policy = RslRlPpoActorCriticRecurrentCfg(
        init_noise_std=0.18,
        noise_std_type="scalar",
        actor_obs_normalization=True,
...
@configclass
class AishaPhase3TargetedRecoveryPPORunnerCfg(AishaPhase3ClearancePlannerPPORunnerCfg):
    """Low-noise Phase 3M deterministic-policy consolidation."""

    seed = 9807
    num_steps_per_env = 64
    max_iterations = 150
    save_interval = 25
    run_name = "phase3m_corrected_physics_recovery_seed9807"
    policy = RslRlPpoActorCriticRecurrentCfg(
        init_noise_std=0.10,
        noise_std_type="scalar",
        actor_obs_normalization=True,
